...
import { ArrowLeft, Edit3, Trash2, Calendar, Heart, ImageIcon, User } from 'lucide-react';
import EditMemeModal from './EditMemeModel';

const ProfilePage = ({ onBack }) => {
  const { user, getUserMemes, deleteMeme, isDarkMode } = useAppContext();
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ${
      ...
      {/* Header */}
      <div className={`sticky top-0 z-40 backdrop-blur-xl border-b transition-all duration-500 ${
        isDarkMode 
                ...
                >
                  ...
                  <div className="relative aspect-square bg-gray-200 dark:bg-gray-600 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-3">
                      ...
                      <button
                        onClick={() => setShowDeleteConfirm(meme.id)}
